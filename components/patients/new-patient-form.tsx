...
import { ArrowLeft, ArrowRight, Check, User, Phone, FileText, Users, CreditCard, Loader2 } from "lucide-react"
...
const insuranceInfoSchema = z.object({
  ...
  relationshipToPatient: z.enum(["self", "spouse", "parent", "other"]).optional(),
})
...
export function NewPatientForm({ isOpen, onClose, onSubmit }: NewPatientFormProps) {
  ...
  const nextStep = async () => {
    ...
    switch (step) {
      case 1:
        isValid = await form.trigger(["firstName", "lastName", "dateOfBirth", "gender", "maritalStatus"])
        break
      case 2:
        isValid = await form.trigger(["address", "city", "state", "zipCode", "phone", "email"])
        break
      case 3:
        ...
        break
      case 4:
        isValid = await form.trigger(["contactName", "relationship", "contactPhone"])
        break
      case 5:
        isValid = await form.trigger([
          "hasInsurance",
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>Check this box if the patient has any known allergies</FormDescription>
                  </div>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="List any past surgeries and dates" className="min-h-[80px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>Does the patient have health insurance?</FormLabel>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2 border rounded-md p-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p>
                      <span className="font-medium">Gender:</span> {form.getValues("gender")}
                    </p>
                    <p>
                      <span className="font-medium">Marital Status:</span> {form.getValues("maritalStatus")}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2 border rounded-md p-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p>
                      <span className="font-medium">City/State/Zip:</span> {form.getValues("city")},{" "}
                ...
                <div className="space-y-2 border rounded-md p-3">
                  ...
                  <div className="text-sm">
                    <p>
                      <span className="font-medium">Blood Type:</span> {form.getValues("bloodType")}
                    </p>
                    <p>
                      <span className="font-medium">Allergies:</span>{" "}
                      {form.getValues("hasAllergies")
                        ? form.getValues("allergies")?.join(", ") || "None specified"
                        : "None"}
                    </p>
                    <p>
                ...
                <div className="space-y-2 border rounded-md p-3">
                  ...
                  <div className="text-sm">
                    <p>
                      <span className="font-medium">Name:</span> {form.getValues("contactName")}
                    </p>
                    <p>
                      <span className="font-medium">Relationship:</span> {form.getValues("relationship")}
                    </p>
                    <p>
                      <span className="font-medium">Phone:</span> {form.getValues("contactPhone")}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2 border rounded-md p-3 md:col-span-2">
                  ...
                  <div className="text-sm">
                    {form.getValues("hasInsurance") ? (
                      <>
                        <p>
                          <span className="font-medium">Provider:</span> {form.getValues("insuranceProvider")}
                        </p>
                        <p>
                          <span className="font-medium">ID:</span> {form.getValues("insuranceId")}
                        </p>
                        <p>
                          <span className="font-medium">Group Number:</span> {form.getValues("groupNumber")}
                        </p>
                        <p>
                          <span className="font-medium">Policy Holder:</span> {form.getValues("policyHolderName")}
                        </p>
                        <p>
                          <span className="font-medium">Relationship to Patient:</span>{" "}
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Please fill out the patient information. All fields marked with an asterisk (*) are required.
          </DialogDescription>
        </DialogHeader>
