...
export function EditInventoryItemDialog({ open, onOpenChange, item, onEdit }: EditInventoryItemDialogProps) {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., box, vial, pack" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Pharmacy, Storage Room B" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
