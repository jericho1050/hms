...
export function NewAppointmentForm({ isOpen, onClose, onSubmit, departments, doctors }: NewAppointmentFormProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Fill out the form below to schedule a new appointment.</DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Include any special instructions or information for this appointment.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
