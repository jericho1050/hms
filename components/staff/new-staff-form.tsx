...
const staffFormSchema = personalInfoSchema
  .merge(employmentDetailsSchema)
  .merge(professionalQualificationsSchema);
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${
                    index < currentStep
                      ...
                      : index === currentStep
                      ? 'bg-primary border border-muted-foreground text-white'
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Highest degree or qualification obtained
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
